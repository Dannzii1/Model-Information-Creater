...
with open('mycsv6.csv','w',newline='') as f:
     thewriter = csv.writer(f)
     thewriter.writerow(['PhotoId','Image','Photoname'])
     for i in range (1,500000):
         thewriter.writerow([fake.random_int(min=1, max=500000),fake.bothify(text='????????'),fake.word()])
...
with open('mycsv8.csv','w',newline='') as f:
     thewriter = csv.writer(f)
     thewriter.writerow(['PostId','PostType','PostBody'])
     for i in range (1,500000):
...
with open('mycsv16.csv','w',newline='') as f:
     ...
     for i in range (1,500000):
         thewriter.writerow([fake.random_int(min=1, max=500000),fake.random.choice(),fake.random_int(min=1, max=500000)])
